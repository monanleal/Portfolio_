...
sr.reveal('#habilidades', {duration: 3000 });
sr.reveal('.caixas', {duration: 2000 });
sr.reveal('.projetos', {duration: 3000 });

sr.reveal('.caixa2P1', {rotate: {x: 0, y: 900, z:0 }, duration: 1500, delay: 1100, origin:'left', distance:'1000px'});
sr.reveal('.caixa2P2', {rotate: {x: 0, y: 900, z:0 }, duration: 1500, delay: 700, origin:'left', distance:'1000px'});
sr.reveal('.caixa2P3', {rotate: {x: 0, y: 500, z:0 }, duration: 1500, delay: 300, origin:'left', distance:'1000px'});
